...
foldername<-'20200310/miniDOT_646496' # folder of the day
...
Retrieval<-'2020-03-07 17:10:00' # Maintain date time format "2020-03-04 21:30:00"
...
Concat_Data <- read_csv(paste0('miniDOT_Oxygen_Sensors/Data/',foldername,'/',filename_cat),
                        col_names = FALSE,
                        skip=9) #skips first 7 rows containing instrument information
...
write_csv(Concat_Data,paste0('miniDOT_Oxygen_Sensors/Data/',foldername,'/',Date,'miniDOTcat.csv'))
